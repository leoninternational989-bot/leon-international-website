    ...
    return (
        <main className="bg-primary-950 min-h-screen">
            <PageHero
                ...
                subtitle="Troubleshooting and fixing various marine electrical panels and equipment."
                breadcrumbs={[
                    { label: 'Services', href: '/services/' },
                    { label: 'Electrical Equipment Repair', href: '/electrical-equipment-repair/' }
                ]}
                image="/images/electrical-equipment-repair/banner.webp"
            />
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            <h2 className="text-3xl font-bold text-white mb-6 font-plus-jakarta-sans">
                                About Our Electrical Equipment Repair
                            </h2>
                            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                                Troubleshooting and fixing various marine electrical panels and equipment. Leon International is a leading marine engineering company with over 50 years of experience. We provide class-approved solutions to ship owners, managers, and offshore industrial operators worldwide from our headquarters in Karachi, and offices in UAE, China, and Latvia.
                            </p>
                        ...
                        <div className="relative h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl border border-white/5 mx-auto w-full">
                            <Image
                                src="/images/electrical-equipment-repair/component.webp"
                                alt="Electrical Equipment Repair performed by Leon International Marine Engineers"
                                fill
                    ...
                    <div className="mt-24 pt-16 border-t border-white/10 w-full">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <FaqAccordion faqs={[
                                {
                                    question: "What electrical equipment repair does Leon International offer?",
                                    answer: "Leon International provides comprehensive electrical equipment repair for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
                                },
                                {
                                    question: "Does Leon International provide emergency electrical equipment repair?",
