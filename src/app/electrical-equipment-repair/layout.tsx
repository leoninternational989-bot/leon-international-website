...
const mainSchema = {
  ...
  "@type": "Service",
  "name": "Electrical Equipment Repair",
  "description": "Troubleshooting and fixing various marine electrical panels and equipment.",
  "provider": {
    "@type": "Organization",
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What electrical equipment repair does Leon International offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Leon International provides comprehensive electrical equipment repair for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
      }
    },
    {
      "@type": "Question",
      "name": "Does Leon International provide emergency electrical equipment repair?",
      "acceptedAnswer": {
        "@type": "Answer",
