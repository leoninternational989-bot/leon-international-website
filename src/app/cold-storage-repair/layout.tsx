...
const mainSchema = {
  ...
  "@type": "Service",
  "name": "Cold Storage Refrigeration Service",
  "description": "Ensuring reliable operation of provision room cooling systems.",
  "provider": {
    "@type": "Organization",
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What cold storage refrigeration service does Leon International offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Leon International provides comprehensive cold storage refrigeration service for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
      }
    },
    {
      "@type": "Question",
      "name": "Does Leon International provide emergency cold storage refrigeration service?",
      "acceptedAnswer": {
        "@type": "Answer",
