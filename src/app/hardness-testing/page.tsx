                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            ...
                            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                                Vickers, Brinell, and Rockwell hardness testing for marine components. Leon International is a leading marine engineering company with decades of experience. We provide class-approved solutions to ship owners, managers, and offshore industrial operators worldwide from our headquarters in Karachi.
                            </p>
                        ...
                        <div className="relative h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl border border-white/5 mx-auto w-full">
                            ...
                            <Image
                                src="/images/hardness-testing/service-1.webp"
                                alt="Marine technician performing material hardness testing on a ship component"
                                fill
