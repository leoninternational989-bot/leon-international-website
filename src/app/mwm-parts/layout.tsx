...
const mainSchema = {
  ...
  "@type": "Product",
  "name": "MWM Engine Replacement Parts",
  "description": "Sourcing OEM-quality parts for MWM gas and diesel engines.",
  "brand": {
    "@type": "Brand",
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What mwm engine replacement parts does Leon International supply?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Leon International supplies high-quality OEM and aftermarket mwm engine replacement parts for marine engines and industrial applications, serving vessels globally."
      }
    },
    {
      "@type": "Question",
      "name": "Are the mwm engine replacement parts OEM or aftermarket?",
      "acceptedAnswer": {
        "@type": "Answer",
