...
export default function Page() {
    return (
        <main className="bg-primary-950 min-h-screen">
            <PageHero
                title="Explosion-Proof (Ex) Equipment"
                subtitle="ATEX-certified lighting and electrical fittings for hazardous areas."
                breadcrumbs={[
                    { label: 'Products', href: '/products/' },
                    { label: 'Explosion-Proof (Ex) Equipment', href: '/explosion-proof/' }
                ]}
            />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            <h2 className="text-3xl font-bold text-white mb-6 font-plus-jakarta-sans">
                                About Our Explosion-Proof (Ex) Equipment
                            </h2>
                            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                                ATEX-certified lighting and electrical fittings for hazardous areas. Leon International is a leading marine engineering company with decades of experience. We provide class-approved solutions to ship owners, managers, and offshore industrial operators worldwide from our headquarters in Karachi.
                            </p>
                        ...
                        <div className="relative h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl border border-white/5 mx-auto w-full">
                            ...
                            <Image
                                src="/images/explosion-proof/service-1.webp"
                                alt="Inspection of explosion-proof marine lighting and electrical fixtures"
                                fill
                    ...
                    <div className="mt-24 pt-16 border-t border-white/10 w-full">
                        ...
                        <div className="max-w-4xl mx-auto space-y-6">
                            ...
                            <div className="bg-primary-900/50 p-6 rounded-xl border border-white/5">
                                <h3 className="text-xl font-bold text-white mb-3">What explosion-proof (ex) equipment does Leon International supply?</h3>
                                <p className="text-gray-300">Leon International supplies high-quality OEM and aftermarket explosion-proof (ex) equipment for marine engines and industrial applications, serving vessels globally.</p>
                            </div>

                            <div className="bg-primary-900/50 p-6 rounded-xl border border-white/5">
                                <h3 className="text-xl font-bold text-white mb-3">Are the explosion-proof (ex) equipment OEM or aftermarket?</h3>
