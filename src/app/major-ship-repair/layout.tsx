...
const mainSchema = {
  ...
  "@type": "Service",
  "name": "Major Ship Repair Projects",
  "description": "Extensive structural and mechanical ship repair projects undertaken globally.",
  "provider": {
    "@type": "Organization",
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What major ship repair projects does Leon International offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Leon International provides comprehensive major ship repair projects for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
      }
    },
    {
      "@type": "Question",
      "name": "Does Leon International provide emergency major ship repair projects?",
      "acceptedAnswer": {
        "@type": "Answer",
