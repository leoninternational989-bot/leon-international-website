    ...
    return (
        <main className="bg-primary-950 min-h-screen">
            <PageHero
                ...
                image="/images/spare-parts-supply/banner.webp"
            />
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="mt-24 pt-16 border-t border-white/10 w-full mb-20">
                        ...
                        <FaqAccordion
                            faqs={[
                                {
                                    question: "What urgent marine spare parts supply does Leon International offer?",
                                    answer: "Leon International provides comprehensive urgent marine spare parts supply for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
                                },
                                {
                                    question: "Does Leon International provide emergency urgent marine spare parts supply?",
