...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What electric motor rewinding does Leon International offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Leon International provides comprehensive electric motor rewinding for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
      }
    },
    {
      "@type": "Question",
      "name": "Does Leon International provide emergency electric motor rewinding?",
      "acceptedAnswer": {
        "@type": "Answer",
