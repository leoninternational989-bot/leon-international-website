...
export default function Page() {
    return (
        <main className="bg-primary-950 min-h-screen">
            <PageHero
                title="Propulsion Systems & Shafts"
                subtitle="Propellers, stern tubes, and bow thruster components."
                breadcrumbs={[
                    { label: 'Products', href: '/products/' },
                    { label: 'Propulsion Systems & Shafts', href: '/propulsion-systems/' }
                ]}
            />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            <h2 className="text-3xl font-bold text-white mb-6 font-plus-jakarta-sans">
                                About Our Propulsion Systems & Shafts
                            </h2>
                            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                                Propellers, stern tubes, and bow thruster components. Leon International is a leading marine engineering company with over 50 years of experience. We provide class-approved solutions to ship owners, managers, and offshore industrial operators worldwide from our headquarters in Karachi, and offices in UAE, China, and Latvia.
                            </p>
