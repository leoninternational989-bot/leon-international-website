                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            ...
                            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                                Expert ship repair, dry docking, and anchorage repair services globally by Leon International. Leon International is a leading marine engineering company with over 50 years of experience. We provide class-approved solutions to ship owners, managers, and offshore industrial operators worldwide from our headquarters in Karachi, and offices in UAE, China, and Latvia.
                            </p>
                        ...
                        <div className="relative h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl border border-white/5 mx-auto w-full">
                            ...
                            <Image 
                                ...
                                alt="Ship Repair & Dry Docking Services performed by Leon International Marine Engineers"
                                fill
                    ...
                    <div className="mt-24 pt-16 border-t border-white/10 w-full">
                        ...
                        <div className="max-w-4xl mx-auto space-y-6">
                            ...
                            <div className="bg-primary-900/50 p-6 rounded-xl border border-white/5">
                                <h3 className="text-xl font-bold text-white mb-3">What ship repair & dry docking services does Leon International offer?</h3>
                                <p className="text-gray-300">Leon International provides comprehensive ship repair & dry docking services for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide.</p>
                            </div>
                            
                            <div className="bg-primary-900/50 p-6 rounded-xl border border-white/5">
                                <h3 className="text-xl font-bold text-white mb-3">Does Leon International provide emergency ship repair & dry docking services?</h3>
