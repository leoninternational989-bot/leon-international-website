    ...
    return (
        <main className="bg-primary-950 min-h-screen">
            <PageHero
                ...
                subtitle="Underwater salvage and buoyancy support using heavy-duty lifting balloons."
                breadcrumbs={[
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            <h2 className="text-3xl font-bold text-white mb-6 font-plus-jakarta-sans">
                                About Our Air Lifting Balloon Services
                            </h2>
                            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                                Underwater salvage and buoyancy support using heavy-duty lifting balloons. Leon International is a leading marine engineering company with decades of experience. We provide class-approved solutions to ship owners, managers, and offshore industrial operators worldwide from our headquarters in Karachi.
                            </p>
                        ...
                        <div className="relative h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl border border-white/5 mx-auto w-full">
                            <Image
                                src="/images/air-lifting/service-1.webp"
                                alt="Marine salvage operation using air lifting balloons"
                                fill
