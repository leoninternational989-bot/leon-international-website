...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What steel fabrication & welding does Leon International offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Leon International provides comprehensive steel fabrication & welding for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
      }
    },
    {
      "@type": "Question",
      "name": "Does Leon International provide emergency steel fabrication & welding?",
      "acceptedAnswer": {
        "@type": "Answer",
