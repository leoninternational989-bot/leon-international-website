...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What magnetic particle inspection (mpi) does Leon International offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Leon International provides comprehensive magnetic particle inspection (mpi) for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
      }
    },
    {
      "@type": "Question",
      "name": "Does Leon International provide emergency magnetic particle inspection (mpi)?",
      "acceptedAnswer": {
        "@type": "Answer",
