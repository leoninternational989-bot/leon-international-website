    ...
    return (
        <main className="bg-primary-950 min-h-screen">
            <PageHero
                ...
                image="/images/main-engine-generator-repair/banner.webp"
            />
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="mt-24 pt-16 border-t border-white/10 w-full">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <FaqAccordion faqs={[
                                {
                                    question: "What main engine & generator overhaul does Leon International offer?",
                                    answer: "Leon International provides comprehensive main engine & generator overhaul for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
                                },
                                {
                                    question: "Does Leon International provide emergency main engine & generator overhaul?",
