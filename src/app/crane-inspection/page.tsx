    ...
    return (
        <main className="bg-primary-950 min-h-screen">
            <PageHero
                ...
                image="/images/crane-inspection/banner.webp"
            />
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        ...
                        <div className="relative h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl border border-white/5 mx-auto w-full">
                            ...
                            <Image
                                src="/images/crane-inspection/component.webp"
                    ...
                    <div className="mt-24 pt-16 border-t border-white/10 w-full">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <FaqAccordion
                                faqs={[
                                    {
                                        question: "What comprehensive crane inspection does Leon International offer?",
                                        answer: "Leon International provides comprehensive comprehensive crane inspection for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
                                    },
                                    {
                                        question: "Does Leon International provide emergency comprehensive crane inspection?",
