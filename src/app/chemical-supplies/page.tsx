...
export const metadata: Metadata = {
    title: 'Chemical Supplies | Leon International',
    description: 'High-quality chemicals essential for various processes within the food industry, meeting strict industry standards for safety and efficacy.',
    alternates: {
        canonical: 'https://leon-international.com/chemical-supplies/',
    },
};
