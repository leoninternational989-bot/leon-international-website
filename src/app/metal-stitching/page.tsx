...
export default function Page() {
    return (
        <main className="bg-primary-950 min-h-screen">
            <PageHero
                title="Cold Metal Stitching"
                subtitle="Repairing cracked or broken cast iron engine blocks without heat."
                breadcrumbs={[
                    { label: 'Services', href: '/services/' },
                    { label: 'Cold Metal Stitching', href: '/metal-stitching/' }
                ]}
                image="/images/metal-stitching/banner.webp"
            />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            <h2 className="text-3xl font-bold text-white mb-6 font-plus-jakarta-sans">
                                About Our Cold Metal Stitching
                            </h2>
                            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                                Repairing cracked or broken cast iron engine blocks without heat. Leon International is a leading marine engineering company with decades of experience. We provide class-approved solutions to ship owners, managers, and offshore industrial operators worldwide from our headquarters in Karachi.
                            </p>
                        ...
                        <div className="relative h-[400px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl border border-white/5 mx-auto w-full">
                            ...
                            <Image
                                src="/images/metal-stitching/component.webp"
                                alt="Cold Metal Stitching performed by Leon International Marine Engineers"
                                fill
                    ...
                    <div className="mt-24 pt-16 border-t border-white/10 w-full">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <FaqAccordion
                                faqs={[
                                    {
                                        question: "What cold metal stitching does Leon International offer?",
                                        answer: "Leon International provides comprehensive cold metal stitching for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
                                    },
                                    {
                                        question: "Does Leon International provide emergency cold metal stitching?",
