...
export const metadata: Metadata = {
    ...
    description: 'Get in touch with Leon International. We are available 24/7 across our offices in Pakistan and globally.',
};
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="flex flex-col gap-8 h-full">
                            ...
                            {/* Embedded Map for HQ filling remaining space */}
                            <div className="flex-grow min-h-[300px] rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative">
                                <iframe
                                    ...
                                    className="filter grayscale hover:grayscale-0 transition-all duration-500 absolute w-full h-full"
                                ></iframe>
                            </div>
                        </div>
                    </div>
