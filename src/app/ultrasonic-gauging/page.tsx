                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            ...
                            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                                Class-approved ultrasonic thickness measurements for vessel hulls and tanks. Leon International is a leading marine engineering company with decades of experience. We provide class-approved solutions to ship owners, managers, and offshore industrial operators worldwide from our headquarters in Karachi.
                            </p>
