...
const mainSchema = {
  ...
  "@type": "Service",
  "name": "Marine Sandblasting & Surface Prep",
  "description": "Grit and hydro blasting to prepare hull surfaces for painting.",
  "provider": {
    "@type": "Organization",
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What marine sandblasting & surface prep does Leon International offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Leon International provides comprehensive marine sandblasting & surface prep for marine vessels and industrial clients at Karachi Port, Bin Qasim anchorage, and worldwide."
      }
    },
    {
      "@type": "Question",
      "name": "Does Leon International provide emergency marine sandblasting & surface prep?",
      "acceptedAnswer": {
        "@type": "Answer",
